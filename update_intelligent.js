...
for (const [filename, pos] of Object.entries(sections)) {
  ...
  let mobileX = 0;
  if (pos.align === 'left') mobileX = -12;
  if (pos.align === 'right') mobileX = 12;
  
  // Tablet target X offset (the safest spot on the screen for this alignment)
  let targetX = 0;
  if (pos.align === 'left') targetX = 12;
  if (pos.align === 'right') targetX = -14;

...
function TextPanel (text, options) {
  ...
  canvas.height = Math.ceil(height + (paddingY * 2));
  ...
  for (var k = 0; k < wordsCount; k++) {
    ...
    if (parameters.align === 'left') {
      ...
      left = canvas.width - paddingX;
    }

    context.fillText(word, left, (lineHeight * k) + paddingY);
  }
...
},{"../classes/SectionClass":3,"../objects3D/TextPanelObject3D":41,"../objects3D/WaveObject3D":42}],60:[function(require,module,exports){
'use strict';

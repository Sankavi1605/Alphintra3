...
// Mathematical proof: The fixed pixel width of the HTML cards maps to a constant 3D offset 
// from the screen edge. As the screen shrinks, the available "empty space" perfectly centers 
// at exactly ±9.4 units in Three.js coordinates.
// By targeting ±9.4, we guarantee the text is perfectly equidistant from the card and the screen edge.
const sections = {
  'ballSection.js': { origX: 15, origY: 0, origZ: 15, origRotX: 0, origRotY: -0.4, mobileX: -6, targetX: 9.4 },
  'beamsSection.js': { origX: -10, origY: 8, origZ: 0, origRotX: 0, origRotY: 0, mobileX: 6, targetX: -9.4 },
  'dropSection.js': { origX: -10, origY: 8, origZ: 0, origRotX: 0, origRotY: 0, mobileX: 6, targetX: -9.4 },
  'endSection.js': { origX: 0, origY: 0, origZ: 0, origRotX: 0, origRotY: 0, mobileX: 0, targetX: 0 },
  'faceSection.js': { origX: 26, origY: 0, origZ: 0, origRotX: 0, origRotY: -0.4, mobileX: -6, targetX: 9.4 },
  'flowSection.js': { origX: 0, origY: 0, origZ: -10, origRotX: 0, origRotY: 0.4, mobileX: 0, targetX: 0 },
  'galaxySection.js': { origX: 0, origY: 20, origZ: -20, origRotX: 0, origRotY: 0, mobileX: 0, targetX: -9.4 },
  'heightSection.js': { origX: -20, origY: 0, origZ: 0, origRotX: 0, origRotY: 0, mobileX: 6, targetX: -9.4 },
...
for (const [filename, pos] of Object.entries(sections)) {
  ...
  if (w <= 900) {
    ...
    var f = w / 1920;
    // Lowered min scale to 0.35 to ensure very long words don't overflow on extreme portrait windows
    var s = Math.max(0.35, Math.min(1.2, f));
    text.el.scale.set(s, s, s);
